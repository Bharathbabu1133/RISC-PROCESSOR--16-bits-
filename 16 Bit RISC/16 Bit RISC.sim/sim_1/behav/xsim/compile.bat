...
REM
REM Generated by Vivado on Sun Nov 09 13:55:54 +0530 2025
...
echo "xvlog --incr --relax -prj decoder_unittest_vlog.prj"
call xvlog  --incr --relax -prj decoder_unittest_vlog.prj -log xvlog.log
